...
class ScrollComponent extends StatefulWidget {
  ...
  double dynamicItemOpacity; // color of current active item 
  ...
  ScrollComponent({required this.listItems, this.backgroundColor = Colors.white, this.color = Colors.grey, this.dynamicItemOpacity = 0.8, this.height = 200,  this.minHeight = 50, required this.maxHeight});
  
  @override
  State<ScrollComponent> createState() => _ScrollComponentState();
}

class _ScrollComponentState extends State<ScrollComponent> with SingleTickerProviderStateMixin{
  int _focusedIndex = 0;
  ...
  Widget _buildListItems(BuildContext context, int index){
    return Container(
          constraints: BoxConstraints(
            minHeight: this.widget.minHeight, //+ 30 : this.widget.minHeight,
      ...
      child: Padding(
        ...
        child: Container(
          child: ScrollSnapList(
            ...
            focusOnItemTap: true,
            dynamicItemOpacity: this.widget.dynamicItemOpacity,
